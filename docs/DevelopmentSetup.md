...
1) Clone the "fedora2-searcher" Git repository:

```bash
> git clone https://github.com/umd-lib/fedora2-searcher.git
```

2) Switch to the "fedora2-searcher" directory:
...
```bash
> pyenv virtualenv 3.10.8 fedora2-searcher
> pyenv shell fedora2-searcher
```
